          ...
          <div>
            ...
            <Row >
              <Col md={6} xs={6} >
                {left.map((table, key) => (
                  <div key={key} className='isoSimpleTable' style={{ alignContent: 'center', marginBottom: '16px', marginTop: '16px' }} >
                    <Tile table={table} type={this.state.tableName} dashboard={this.props.dashboard} tileIndex={key} updateDash={this.updateDash} isFull={this.props.isFull} />
                  </div>
                ))
                }
              </Col>
              <Col md={6} xs={6} >
                {right.map((table, key) => (
                  <div key={key} className='isoSimpleTable' style={{ alignContent: 'center', marginBottom: '16px', marginTop: '16px' }} >
                    <Tile table={table} type={this.state.tableName} dashboard={this.props.dashboard} tileIndex={(2 * key) + 1} updateDash={this.updateDash} isFull={this.props.isFull} />
                  </div>
                ))
                }
              </Col>
